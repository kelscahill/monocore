...
function register_custom_block_types() {
  if ( function_exists( 'acf_register_block_type' ) ) {
    ...
    /* Register a latest posts block. */
    acf_register_block_type(
      array(
        'name'            => 'latest_posts',
        'title'           => 'Latest Posts',
        'description'     => 'Use this block to create a feed layout for displaying posts in a visually appealing manner.',
        'category'        => 'custom',
        'icon'            => 'insert',
        'keywords'        => array( 'latest', 'posts', 'feed', 'section' ),
        'render_template' => '/resources/views/blocks/latest-posts.php',
        'mode'            => 'edit',
        'supports'        => array(
          'mode' => false,
          'anchor' => true,
